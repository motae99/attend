    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="btn-group col-sm-12">
                <div class="col-sm-4">
                    <button class="btn btn-flat btn-block margin bg-maroon" type="button" value="bg-maroon"> # </button>
                ...
                <div class="col-sm-4">
                    <button class="btn btn-flat btn-block margin bg-purple" type="button"> # </button>
                ...
                <div class="col-sm-4">
                    <button class="btn btn-flat btn-block margin bg-blue" type="button"> # </button>
