        ...
        Nav::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => '<i class="fa fa-file-code-o"></i><span>Customers</span>', 'url' => ['/customer']],
                    ['label' => '<i class="fa fa-file-code-o"></i><span>Engineers</span>', 'url' => ['/engineers']],
